...
const styles = ['Todos', 'Realismo', 'Blackwork', 'Tribal', 'Geométrico', 'Aquarela', 'Mandala', 'Fineline']
const bodyParts = ['Todas as Áreas', 'Braço', 'Perna', 'Costas', 'Peito', 'Pescoço', 'Antebraço']
...
const styleQueries: Record<string, string> = {
  ...
  Aquarela: 'watercolor tattoo colorful',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-52 md:h-80 bg-black overflow-hidden mt-16">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <h1 className="font-display text-3xl sm:text-5xl md:text-7xl text-white tracking-wide">PORTFÓLIO COMPLETO</h1>
          <p className="text-zinc-400 font-body text-sm mt-3">Cada tatuagem conta uma história única</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 py-8 md:py-12">
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-4">
            <p className="font-body text-sm text-zinc-500">{photos.length} trabalhos encontrados</p>
            <button
          ...
          {showFilters && (
            <FadeIn>
              <div className="p-5 bg-zinc-50 rounded-xl border border-zinc-100">
                <div>
                  <label className="block text-xs font-body tracking-widest text-zinc-400 uppercase mb-2">Parte do Corpo</label>
                  <select
              ...
              >
                ...
                <div className="overlay absolute inset-0 bg-black/55 flex flex-col items-center justify-center gap-2 p-4">
                  ...
                  <p className="text-white text-xs font-body font-medium tracking-widest text-center opacity-80">
                    {activeStyle !== 'Todos' ? activeStyle.toUpperCase() : 'TATTOO'}
                  </p>
                </div>
              </div>
            ))}
        ...
        <div className="mt-20 bg-black rounded-2xl p-10 md:p-14 text-center">
          <p className="text-xs font-body tracking-[0.3em] text-zinc-500 uppercase mb-3">Gostou do que viu?</p>
          <h2 className="font-display text-4xl md:text-5xl text-white tracking-wide mb-4">QUERO UMA ASSIM</h2>
          <p className="text-zinc-400 font-body text-sm max-w-md mx-auto mb-8">
            Encontrou inspiração? Agende uma consulta e vamos criar a tatuagem perfeita para você.
          </p>
          <Link
            to="/agendamento"
