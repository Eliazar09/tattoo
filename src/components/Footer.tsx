      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-400 text-sm font-body max-w-md mx-auto">
            Arte permanente, experiência única. Transformamos sua visão em arte na pele.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          {/* Serviços */}
          <div>
            <h4 className="font-display text-lg tracking-widest text-white mb-4">SERVIÇOS</h4>
            <ul className="space-y-2">
          ...
          {/* Contato */}
          <div>
            <h4 className="font-display text-lg tracking-widest text-white mb-4">CONTATO</h4>
          ...
          {/* Redes Sociais */}
          <div>
            <h4 className="font-display text-lg tracking-widest text-white mb-4">SIGA-NOS</h4>
            ...
            <p className="text-zinc-500 text-xs font-body">@nonostudio</p>
          </div>
        </div>
        ...
        <div className="relative flex items-center mb-8">
          ...
          <span className="px-4 font-display text-2xl text-zinc-700 tracking-widest">✦ NO NO ✦</span>
          <div className="flex-1 h-px bg-zinc-800" />
        </div>

        {/* Copyright */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-zinc-600 text-xs font-body">
          <p>© {new Date().getFullYear()} NO NO Estúdio de Tatuagem. Todos os direitos reservados.</p>
