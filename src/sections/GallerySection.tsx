...
const categories = ['Todos', 'Realismo', 'Blackwork', 'Tribal', 'Geométrico', 'Aquarela']
    ...
    <section id="galeria" className="bg-[#0D0D0D] py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <FadeIn className="text-center mb-10">
          <p className="text-xs font-body tracking-[0.3em] text-zinc-500 uppercase mb-3">Portfolio</p>
