  ...
  return (
    <section id="contato" className="bg-black py-20 lg:py-28 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-6 md:px-12 text-center">
        <FadeIn>
          <p className="text-xs font-body tracking-[0.3em] text-zinc-500 uppercase mb-4">Fique por dentro</p>
          ...
          <p className="text-zinc-400 font-body text-sm leading-relaxed mb-8 max-w-md mx-auto">
            Receba novidades, promoções exclusivas e inspirações de tattoo diretamente no seu e-mail.
          </p>
          ...
          {sent ? (
            <div className="flex flex-col items-center gap-3 py-8">
              ...
              <p className="text-zinc-400 text-sm font-body">Em breve você receberá novidades do NO NO.</p>
            </div>
          ) : (
