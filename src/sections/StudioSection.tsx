...
const POSTS = [
  'https://www.instagram.com/p/DHmeIyDMShL/',
  'https://www.instagram.com/p/DCDBEOMSwPt/',
  'https://www.instagram.com/p/DACM2ciyXUK/',
  'https://www.instagram.com/p/C_b4dpsspCE/',
  'https://www.instagram.com/p/C7iIBMNsOz-/',
]
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <FadeIn className="text-center mb-12">
          ...
          <p className="text-zinc-400 font-body text-base max-w-lg mx-auto">
            Acompanhe nossos trabalhos direto do Instagram
          </p>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-14">
          {[
            { Icon: ShieldCheck, title: 'Biossegurança', desc: 'Equipamentos esterilizados e ambiente higienizado conforme normas da ANVISA.' },
            { Icon: Star, title: 'Ambiente Premium', desc: 'Espaço projetado para proporcionar conforto e inspiração durante toda a sessão.' },
            { Icon: Lock, title: 'Privacidade', desc: 'Cabines privativas para sessões mais íntimas e confortáveis.' },
          ].map(({ Icon, title, desc }) => (
