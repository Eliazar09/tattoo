...
const stats = [
  ...
  { end: 10, prefix: '', suffix: '+', label: 'Anos' },
  { end: 15, prefix: '', suffix: '', label: 'Prêmios' },
]
    ...
    <section id="sobre" className="bg-white py-20 lg:py-32 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <FadeIn className="text-center mb-16">
          <p className="text-xs font-body tracking-[0.3em] text-zinc-400 uppercase mb-3">Nossa História</p>
          <h2 className="font-display text-5xl md:text-6xl lg:text-7xl tracking-wide mb-3">SOBRE NÓS</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative inline-block w-full">
              ...
              >
                {photo ? (
                  <img
                    src={photo.src.large}
                    alt={photo.alt || 'Estúdio NO NO'}
                    className="w-full h-[480px] object-cover"
                    loading="lazy"
                  />
                ) : (
                  <div className="w-full h-[480px] bg-zinc-100 flex items-center justify-center">
                    <span className="font-display text-6xl text-zinc-300">NO NO</span>
                  </div>
                )}
              </div>
              {/* Signature overlay */}
          ...
          <FadeIn direction="right" delay={200}>
            <p className="text-xs font-body tracking-[0.3em] text-zinc-400 uppercase mb-3">Quem somos</p>
            <h3 className="font-display text-3xl md:text-4xl tracking-wide mb-5">
              PERFEIÇÃO QUE É ETERNA
            </h3>
            <p className="text-zinc-500 font-body text-base leading-relaxed mb-4">
              O Estúdio NO NO nasceu da paixão pela arte e pelo desejo de criar tatuagens que vão além do simples desenho — são histórias gravadas na pele para sempre.
            </p>
            <p className="text-zinc-500 font-body text-base leading-relaxed mb-6">
              Com uma equipe de artistas altamente qualificados e um ambiente sofisticado, oferecemos uma experiência única e personalizada para cada cliente. Cada tatuagem é uma obra de arte exclusiva, criada com dedicação e precisão.
            </p>
