...
const services = [
  ...
  { name: 'Piercing', query: 'piercing jewelry' },
    ...
    <section id="servicos" className="bg-[#F8F8F8] py-14 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <FadeIn className="text-center mb-14">
          <p className="text-xs font-body tracking-[0.3em] text-zinc-400 uppercase mb-3">O que fazemos</p>
          <h2 className="font-display text-5xl md:text-6xl lg:text-7xl tracking-wide mb-3">NOSSOS SERVIÇOS</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          {services.map((s, i) => (
            <FadeIn key={s.name} delay={i * 80}>
              <Link to="/agendamento" className="gallery-item group relative rounded-xl overflow-hidden cursor-pointer aspect-square bg-zinc-200 block">
                {photos[i] ? (
                  <img
        ...
        <FadeIn>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 py-6 border-y border-zinc-200">
            ...
            <a
              href="https://wa.me/5595981019856?text=Ol%C3%A1!%20Gostaria%20de%20solicitar%20um%20or%C3%A7amento%20para%20uma%20tatuagem."
              target="_blank"
        ...
        <FadeIn>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center bg-white rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="p-6 md:p-8 lg:p-12">
              <p className="text-xs font-body tracking-[0.3em] text-zinc-400 uppercase mb-3">Destaque</p>
              ...
              <p className="text-zinc-500 font-body text-sm leading-relaxed mb-6">
                Nossa especialidade. Transformamos fotografias e ideias em obras de arte permanentes na pele com impressionante fidelidade de detalhes, texturas e sombreamentos.
              </p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="https://wa.me/5595981019856?text=Ol%C3%A1!%20Tenho%20interesse%20em%20uma%20tatuagem%20realista.%20Pode%20me%20passar%20um%20or%C3%A7amento%3F"
                  target="_blank"
                  rel="noopener noreferrer"
