    ...
    <section className="bg-white py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <FadeIn className="text-center mb-10">
          <p className="text-xs font-body tracking-[0.3em] text-zinc-400 uppercase mb-2">Redes Sociais</p>
          <div className="flex items-center justify-center gap-3 mb-1">
            <Instagram size={28} className="text-black" />
            <h2 className="font-display text-4xl md:text-5xl tracking-wide">SIGA-NOS NO INSTAGRAM</h2>
          </div>
          <a
            href="https://instagram.com/nonostudio"
            target="_blank"
